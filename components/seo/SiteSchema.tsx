...
const ADDRESS =
  "تهران، شهریار، جنب پمپ بنزین شاهد شهر، خیابان معاینه فنی، پلاک 6";
...
export default function SiteSchema() {
  const organizationSchema = {
    ...
    telephone: PHONE_1,
    description:
      "تکنو ماشین صنعت، فعال در زمینه تأمین ماشین‌آلات صنعتی و معدنی، تجهیزات، قطعات و ارائه راهکارهای فنی و مهندسی.",
    address: {
      "@type": "PostalAddress",
