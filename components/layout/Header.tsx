        ...
        <div className="flex h-20 items-center justify-between gap-8">
          ...
          >
            {navigation.map((item, index) => (
              ...
              >
                ...
                {index === 0 && (
                  <span className="absolute bottom-0 right-0 h-0.5 w-6 bg-brand-gold" />
                )}
              </Link>
            ))}
          </nav>
          ...
          >
            <span className="flex flex-col gap-1.5">
              <span
                className={`h-0.5 w-5 transition-transform duration-300 ${
                  isMenuOpen ? "translate-y-2 rotate-45" : ""
                } bg-current`}
              />

              <span
                className={`h-0.5 w-5 transition-opacity duration-300 ${
