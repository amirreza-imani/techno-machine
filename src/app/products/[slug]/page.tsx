					...
					<div className='grid items-center gap-12 py-16 md:py-20 lg:grid-cols-[480px_1fr] lg:gap-20'>
						...
						<div className='order-1 flex justify-start'>
							<div className='relative h-[280px] w-full max-w-[440px] overflow-hidden rounded-3xl border border-white/10 bg-brand-charcoal shadow-2xl md:h-[330px]'>
								...
								<div aria-hidden='true' className='pointer-events-none absolute inset-4 rounded-2xl border border-brand-gold/30' />

								<div className='absolute bottom-5 right-5 rounded-lg border border-white/10 bg-brand-black/70 px-4 py-2 backdrop-blur-md'>
									<span className='text-xs font-bold text-brand-gold'>محصولات تکنو ماشین</span>
								</div>
							</div>
						</div>
						...
						<div className='order-2'>
							...
							<p className='mt-6 max-w-2xl text-base leading-8 text-white/60 md:text-lg'>
								مجموعه‌ای از ماشین‌آلات و تجهیزات تخصصی مورد استفاده در صنایع معدنی و صنعتی، با تمرکز بر کیفیت، عملکرد و راهکارهای متناسب با نیاز پروژه.
							</p>
						</div>
					</div>
				</Container>
				...
				<Container>
					{products.length === 0 ? (
						<div className='rounded-2xl border border-gray-200 bg-white px-6 py-16 text-center shadow-sm'>
							<div className='mx-auto flex h-14 w-14 items-center justify-center rounded-xl bg-brand-black text-xl font-black text-brand-gold'>TM</div>

							<h2 className='mt-5 text-xl font-black text-brand-black'>محصولی برای نمایش وجود ندارد</h2>

							<p className='mx-auto mt-3 max-w-md text-sm leading-7 text-gray-500'>در حال حاضر محصولی در سیستم ثبت نشده است. لطفاً بعداً دوباره مراجعه کنید.</p>
						...
						<>
							<div className='mb-9 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between'>
								<div>
									...
									<h2 className='mt-2 text-2xl font-black text-brand-black md:text-3xl'>محصولات تکنو ماشین</h2>
								</div>

								<div className='text-sm text-gray-400'>{products.length} محصول</div>
							</div>
			...
			<section className='bg-brand-black py-12'>
				<Container>
					<div className='flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center'>
						<div>
							<span className='text-xs font-bold text-brand-gold'>راهکار متناسب با پروژه شما</span>

							<h2 className='mt-2 text-xl font-black text-white md:text-2xl'>محصول مناسب پروژه خود را پیدا نکردید؟</h2>
						</div>
