  ...
  ========================================================= */
	...
	return (
        ...
        ========================================================= */}
				...
				<section aria-labelledby='home-hero-title' className='relative overflow-hidden bg-brand-black'>
					{/* Decorative elements */}
					...
					<div aria-hidden='true' className='pointer-events-none absolute -bottom-40 right-0 h-96 w-96 rounded-full bg-brand-charcoal blur-3xl' />
						...
						<div className='grid min-h-[calc(100vh-180px)] items-center gap-10 py-12 lg:grid-cols-2 lg:py-14'>
							...
							<div className='relative z-10'>
								...
								<h1 id='home-hero-title' className='max-w-3xl text-4xl font-black leading-[1.3] text-white sm:text-5xl lg:text-6xl'>
									راهکارهای تخصصی
									<span className='block text-brand-gold'>ماشین‌آلات و تجهیزات صنعتی</span>
								</h1>
							...
							<div className='relative hidden lg:block'>
								<div className='relative mx-auto aspect-square max-w-[440px]'>
									<div aria-hidden='true' className='absolute inset-8 rotate-3 border border-brand-gold/20' />
									...
									<div className='absolute inset-0 flex items-center justify-center'>
										<div className='relative flex h-[330px] w-[330px] items-center justify-center rounded-full border border-white/10 bg-brand-charcoal/60'>
											...
											<div className='text-center'>
												<Image src='/images/IMG_5071.PNG' alt=' تکنو ماشین ' width={192} height={192} priority className='mx-auto h-auto w-48 object-contain' />
									...
									<div className='absolute right-0 top-20 border border-white/10 bg-white/5 px-5 py-3 backdrop-blur-sm'>
										...
										<div className='mt-1 text-sm font-bold text-white'>مهندسی صنعتی</div>
									</div>
									...
									<div className='absolute bottom-16 left-0 border border-brand-gold/20 bg-brand-gold/10 px-5 py-3 backdrop-blur-sm'>
										...
										<div className='mt-1 text-sm font-bold text-brand-gold'>از تأمین تا اجرا</div>
									</div>
								</div>
							</div>
						</div>
        ...
        ========================================================= */}
				...
				<section aria-labelledby='about-intro-title' className='bg-surface-soft py-16 transition-colors duration-300 md:py-20'>
					<Container>
						<div className='grid gap-12 lg:grid-cols-[1.05fr_1fr] lg:items-center'>
							<div>
								<div className='mb-5 flex items-center gap-3'>
									...
									<span className='text-sm font-bold text-brand-gold'>درباره تکنو ماشین</span>
								</div>

								<h2 id='about-intro-title' className='max-w-xl text-3xl font-black leading-[1.4] text-foreground md:text-4xl'>
									تخصص صنعتی،
							...
							<div className='grid gap-3 sm:grid-cols-3 lg:grid-cols-1'>
								<div className='border-r-2 border-brand-gold bg-surface px-6 py-5 shadow-sm transition-colors duration-300'>
									...
									<p className='mt-1 text-xs leading-6 text-muted'>شناخت نیازهای فنی و صنعتی پروژه</p>
								</div>

								<div className='border-r-2 border-brand-gold bg-surface px-6 py-5 shadow-sm transition-colors duration-300'>
									<h3 className='text-lg font-black text-foreground'>کیفیت</h3>

									<p className='mt-1 text-xs leading-6 text-muted'>تمرکز بر تجهیزات و راهکارهای قابل اعتماد</p>
								</div>

								<div className='border-r-2 border-brand-gold bg-surface px-6 py-5 shadow-sm transition-colors duration-300'>
									<h3 className='text-lg font-black text-foreground'>پشتیبانی</h3>

									<p className='mt-1 text-xs leading-6 text-muted'>همراهی از تأمین تا اجرای راهکار</p>
								</div>
							</div>
						</div>
					</Container>
        ...
        ========================================================= */}
				...
				<section aria-labelledby='services-title' className='bg-background py-16 transition-colors duration-300 md:py-20'>
					<Container>
						<div className='mb-10 flex flex-col justify-between gap-5 md:flex-row md:items-end'>
							<div>
								<div className='mb-4 flex items-center gap-3'>
									...
									<span className='text-sm font-bold text-brand-gold'>خدمات و توانمندی‌ها</span>
								</div>

								<h2 id='services-title' className='max-w-2xl text-3xl font-black leading-[1.4] text-foreground md:text-4xl'>
									راهکار تخصصی،
									<span className='block text-brand-gold'>از تأمین تا اجرا</span>
								</h2>
							</div>

							<p className='max-w-md text-sm leading-7 text-muted'>مجموعه‌ای از خدمات تخصصی برای تأمین تجهیزات، قطعات و ارائه راهکارهای فنی متناسب با نیاز پروژه‌های صنعتی و معدنی.</p>
						</div>
							...
							{[
								{
									...
									description: 'تأمین ماشین‌آلات و تجهیزات تخصصی مورد نیاز صنایع معدنی و صنعتی با تمرکز بر انتخاب راهکار مناسب.',
								},
								{
									number: '۰۲',
									title: 'تأمین قطعات',
									description: 'تأمین قطعات و تجهیزات مورد نیاز ماشین‌آلات صنعتی با توجه به مشخصات فنی و نیاز واقعی پروژه.',
								},
								{
									number: '۰۳',
									title: 'خدمات فنی و مهندسی',
									description: 'ارائه مشاوره و راهکارهای فنی و مهندسی برای انتخاب و استفاده صحیح از تجهیزات متناسب با پروژه.',
								},
								{
									number: '۰۴',
									title: 'پشتیبانی و مشاوره',
									description: 'همراهی و پشتیبانی تخصصی در مسیر انتخاب، تأمین و اجرای راهکارهای مورد نیاز پروژه.',
								},
							].map((service) => (
								<article
									key={service.number}
								...
								>
									<div className='mb-8 flex items-start justify-between'>
										<span className='text-xs font-bold tracking-wider text-brand-gold'>{service.number}</span>

										<span aria-hidden='true' className='text-2xl text-muted/30 transition-colors duration-300 group-hover:text-brand-gold/50'>
											◇
										</span>
									</div>
        ...
        ========================================================= */}
				...
				<section aria-labelledby='products-title' className='bg-surface-soft py-20 transition-colors duration-300'>
					<Container>
						<div className='mb-10 flex flex-col justify-between gap-5 sm:flex-row sm:items-end'>
							<div>
								<span className='text-sm font-bold text-brand-gold'>محصولات</span>

								<h2 id='products-title' className='mt-2 text-3xl font-black text-foreground'>
									محصولات منتخب
								</h2>
							</div>

							<Link href='/products' className='text-sm font-bold text-foreground transition-colors hover:text-brand-gold'>
								مشاهده همه محصولات
						...
						{featuredProducts.length > 0 ? (
								...
								{featuredProducts.map((product) => {
									...
									return (
										...
										>
											...
											<div className='p-6'>
												{product.featured && <span className='text-xs font-bold text-brand-gold'>محصول ویژه</span>}

												<h3 className='mt-2 text-xl font-black text-foreground'>{product.title}</h3>

												{product.shortDescription && <p className='mt-3 line-clamp-2 text-sm leading-7 text-foreground-soft'>{product.shortDescription}</p>}
							...
							<div className='rounded-xl border border-border-theme bg-surface p-8 text-center'>
								<p className='text-sm text-muted'>محصولات به‌زودی در سایت قرار خواهند گرفت.</p>
							</div>
						)}
					</Container>
				</section>
        ...
        ========================================================= */}
				...
				<section aria-labelledby='why-us-title' className='bg-background py-16 transition-colors duration-300 md:py-20'>
					<Container>
						<div className='mb-10 flex flex-col justify-between gap-5 sm:flex-row sm:items-end'>
							<div>
								<span className='text-sm font-bold text-brand-gold'>چرا تکنو ماشین؟</span>

								<h2 id='why-us-title' className='mt-2 text-3xl font-black text-foreground'>
									یک همراه تخصصی برای پروژه‌های صنعتی
								</h2>
							</div>

							<p className='max-w-xl text-sm leading-7 text-muted'>از انتخاب تجهیزات مناسب تا تأمین قطعات و پشتیبانی فنی، در کنار شما هستیم تا راهکار مناسب پروژه‌تان را پیدا کنیم.</p>
						</div>
						...
						<div className='grid gap-5 md:grid-cols-3'>
							<article className='group rounded-xl border border-border-theme bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-brand-gold/40 hover:shadow-lg'>
								<div className='flex h-12 w-12 items-center justify-center rounded-sm bg-brand-black text-lg font-black text-brand-gold'>01</div>

								<h3 className='mt-5 text-xl font-black text-foreground'>تخصص فنی</h3>

								<p className='mt-3 text-sm leading-7 text-muted'>شناخت نیازهای فنی صنایع و ارائه تجهیزات و قطعات متناسب با شرایط واقعی هر پروژه.</p>
							</article>

							<article className='group rounded-xl border border-border-theme bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-brand-gold/40 hover:shadow-lg'>
								<div className='flex h-12 w-12 items-center justify-center rounded-sm bg-brand-black text-lg font-black text-brand-gold'>02</div>

								<h3 className='mt-5 text-xl font-black text-foreground'>تأمین مطمئن</h3>

								<p className='mt-3 text-sm leading-7 text-muted'>تمرکز بر تأمین ماشین‌آلات، قطعات و تجهیزات صنعتی با کیفیت و متناسب با نیاز پروژه.</p>
							</article>

							<article className='group rounded-xl border border-border-theme bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-brand-gold/40 hover:shadow-lg'>
								<div className='flex h-12 w-12 items-center justify-center rounded-sm bg-brand-black text-lg font-black text-brand-gold'>03</div>

								<h3 className='mt-5 text-xl font-black text-foreground'>پشتیبانی تخصصی</h3>

								<p className='mt-3 text-sm leading-7 text-muted'>همراهی و پشتیبانی فنی برای ایجاد اطمینان بیشتر در مسیر تأمین و استفاده از تجهیزات.</p>
							</article>
						</div>
					</Container>
				</section>
        ...
        ========================================================= */}
				...
				<section aria-labelledby='home-cta-title' className='bg-brand-black py-16'>
					<Container>
						<div className='flex flex-col items-start justify-between gap-7 sm:flex-row sm:items-center'>
							<div>
								<span className='text-sm font-bold text-brand-gold'>آماده همکاری هستیم</span>

								<h2 id='home-cta-title' className='mt-2 text-2xl font-black text-white md:text-3xl'>
