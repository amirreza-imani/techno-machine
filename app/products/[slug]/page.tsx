...
export const metadata: Metadata = {
  ...
  description:
    "معرفی ماشین‌آلات و تجهیزات صنعتی و معدنی تکنو ماشین؛ شامل سنگ شکن، سرند، نوار نقاله، ماسه‌ساز و تجهیزات خطوط خردایش.",
  alternates: {
    canonical: "/products",
  },
  openGraph: {
    ...
    description:
      "معرفی ماشین‌آلات و تجهیزات صنعتی و معدنی تکنو ماشین برای پروژه‌های خردایش و فرآوری.",
    type: "website",
    url: "/products",
    locale: "fa_IR",
    siteName: "تکنو ماشین",
