...
export async function generateMetadata({
  ...
  const description =
    ...
    `معرفی ${product.title} و مشخصات این محصول از محصولات تکنو ماشین.`;
                ...
                <div className="relative aspect-[4/3] overflow-hidden rounded-3xl border border-white/10 bg-brand-charcoal shadow-2xl">
                  {imageUrl ? (
                    ...
                    <div className="relative flex h-full items-center justify-center">
                      ...
                      <span className="relative text-8xl font-black tracking-tighter text-brand-gold/20">
                        TM
                      </span>
                    </div>
                  )}
                  ...
                  {product.featured && (
                    <div className="absolute right-5 top-5 rounded-md bg-brand-gold px-4 py-2 text-xs font-black text-brand-black shadow-lg">
                      محصول ویژه
                    </div>
                  )}
                  ...
                  <div
                    aria-hidden="true"
                    className="pointer-events-none absolute inset-4 rounded-2xl border border-brand-gold/20"
                  />
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm md:p-10">
              ...
              {product.description && product.description.length > 0 ? (
                ...
                <p className="text-sm leading-8 text-gray-400">
                  اطلاعات تکمیلی این محصول در حال به‌روزرسانی است.
                </p>
              )}
            </div>
            ...
            <aside className="h-fit rounded-3xl bg-brand-black p-7 text-white shadow-xl">
              ...
              <h2 className="mt-3 text-xl font-black leading-8">
                برای دریافت قیمت و مشاوره با ما در تماس باشید.
              </h2>

              <p className="mt-4 text-sm leading-7 text-white/50">
                کارشناسان تکنو ماشین آماده پاسخگویی و ارائه اطلاعات فنی و تجاری
                مورد نیاز شما هستند.
              </p>
        ...
        <Container>
          <div className="flex flex-col items-start justify-between gap-5 sm:flex-row sm:items-center">
            <div>
              ...
              <h2 className="mt-2 text-xl font-black text-brand-black">
                مشاهده سایر محصولات
              </h2>
            </div>
