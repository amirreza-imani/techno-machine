import {
  ...
  HOOKS
} from "./chunk-3HKOWYSM.js";
import {
  useNpsSurveySettings
} from "./chunk-VPJ3MXWC.js";
import {
  require_pick
...
import {
  Login
} from "./chunk-WHLA25GB.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-G4E7WFTA.js";
import {
  ConfigurationProvider
} from "./chunk-ENNLBATI.js";
import {
  useClipboard
} from "./chunk-CPGXF6JK.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-GV2LAIFZ.js";
import {
  useGetAiUsageQuery
} from "./chunk-SMDBRE2T.js";
import {
  useEnterprise
} from "./chunk-5WLG56LU.js";
import {
  _setPrototypeOf
...
} from "./chunk-LZJBYPBG.js";
import {
  Form
} from "./chunk-2EWE25V3.js";
import {
  Layouts
} from "./chunk-FHLJEXAN.js";
import {
  getByteSize
...
import {
  ...
  useTypedSelector,
  useTypedStore
} from "./chunk-RDFRL2DX.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-OGUN24ZU.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-QXW2BNO4.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-MB2KBNMC.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await retryDynamicImport(() => import("./Login-UUIGWUV7.js"))).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await retryDynamicImport(() => import("./constants-5QSJRJJO.js"))).FORMS, {
...
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-SRHAIH4L.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-JW2YWVZD.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-IC2NOWXP.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-DZBTY5PC.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-OZRRUSXA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-HVJ7OPM3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CSTL7D3X.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-F4LHSRMB.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-L37GIOQG.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-LQH2KP42.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GPYM6S4M.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-3LTDAFGK.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-BCADCCS5.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-SHD4C2C2.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-6FTB4PVO.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-VDTSWHPF.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-7TS6W4Q2.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-5Z4EGNKY.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-GH2Q3ZJK.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-AH54J5AV.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-HDRVNUKJ.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-CCUIOSXU.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-GZLHBUAS.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-WEWBRE25.js");
      return {
  ...
  },
  {
    path: "me/sessions",
    lazy: async () => {
      const { SessionsPage } = await import("./SessionsPage-3XVAX4OS.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-5J3IJOHB.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-RAV6CWIJ.js");
          return {
  ...
  */
  createRouter(strapi, { memory, ...opts } = {}) {
    const authenticatedLayoutRoute = {
      path: "/*",
      lazy: async () => {
        const { PrivateAdminLayout } = await import("./AuthenticatedLayout-6VPFQBTP.js");
        return {
  ...
  async register(customRegister) {
    const widgets = [
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-EBHVFXKX.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-EBHVFXKX.js");
    ...
    if ("strapi-cloud" in this.appPlugins) {
      widgets.push({
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-EBHVFXKX.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-7ADE2VQQ.js");
...
//# sourceMappingURL=chunk-TFPRTVSA.js.map
