...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-CVRZLLBE.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-FKXR7HYN.js")).AIUsage, {
    enabled: isAiEnabled
  });
...
//# sourceMappingURL=ApplicationInfoPage-RAV6CWIJ.js.map
