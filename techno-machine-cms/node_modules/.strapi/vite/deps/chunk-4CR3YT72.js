import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-Z4B2OKWV.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-PAY54OVR.js";
import {
  getStageColorByHex
} from "./chunk-3QVGJUEB.js";
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-J64A46KY.js";
import {
...
} from "./chunk-T4BHC5DV.js";
import {
  index
} from "./chunk-GZ3RNU7E.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-DDFA5TVM.js";
import {
  useConfig
} from "./chunk-TWJ5NLAX.js";
import {
  useTracking
} from "./chunk-FEPIO57F.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-QVBYDGJK.js";
import {
  pluginId
} from "./chunk-5QJFIL32.js";
import {
  useDocumentActions
} from "./chunk-PZTHPEIG.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-FESGDJ7R.js";
import {
  renderAdmin,
  require_baseUniq,
  useDebounce
} from "./chunk-TFPRTVSA.js";
import {
  useAIAvailability
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-5J6AZBPC.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-IHMHPKNZ.js").then((mod) => ({
  ...
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: isBetaMediaLibrary ? () => {
        return import("./App-76NW5P75.js").then((mod) => ({
          default: mod.BetaMediaLibrary
        }));
      } : () => {
        return import("./App-UNIMVIB7.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-35FGE5JT.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-DWMXTTPK.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-6CG6O6DM.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-XXT5ARFC.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-VUQJ4CGO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-RHTLWYL3.js").then((mod) => ({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-SC6VGR6N.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-4SPT2YL2.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-TNGSVAZN.js").then((mod) => ({
...
//# sourceMappingURL=chunk-4CR3YT72.js.map
